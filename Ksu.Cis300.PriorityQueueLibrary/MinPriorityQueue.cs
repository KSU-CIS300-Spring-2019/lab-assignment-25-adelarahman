...
{
    /// <summary>
    /// Min Priority Queue class that handles the min priority from the leftist heap.
    /// </summary>
    ...
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            else
            {
                ...
                {
                    LeftistTree<KeyValuePair<TPriority, TValue>> otherNewRoot = new LeftistTree<KeyValuePair<TPriority, TValue>>(h2.Data, h2.LeftChild, Merge(h2.RightChild, h1));
                    return otherNewRoot;
                }
            }
        }
        ...
        /// <summary>
        /// Method that gets the minimum property from the leftist heap.
        /// </summary>
        ...
        /// <summary>
        /// Remove minimum method that will remove the root in the case _elements is non empty.
        /// </summary>
        /// <returns>the root being removed.</returns>
