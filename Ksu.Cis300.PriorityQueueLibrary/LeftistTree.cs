...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    ...
    public partial class LeftistTree<T> : ITree
    {
        ...
        /// <summary>
        /// Public method handling the null path length from tge leftist tree.
        /// </summary>
        /// <param name="t">the leftist tree</param>
        /// <returns>the leftist trees null path length if nonempty. else 0.</returns>
